...
local function toggleStrafe()
    if isStrafing then
        ...
        Library:Notify('Unstrafing ' .. (strafeTargetPlayer and strafeTargetPlayer.Name or ''))
        ...
        if strafeTargetPlayer then
            ...
            Library:Notify('Strafing ' .. strafeTargetPlayer.Name)
        end
    end
end
...
local function toggleDesyncState(state)
    ...
    if desyncConfig.enabled then
        ...
        Library:Notify("Desync Enabled '" .. desyncConfig.mode .. "' hoodware.lol $", 2)
    else
        resetCameraToPlayer()
        Library:Notify("Desync Disabled '" .. desyncConfig.mode .. "' hoodware.lol $", 2)
    end
end
...
playerActionsGroupbox:AddButton('Execute Action', function()
    ...
    if targetPlayer and targetPlayer.Character then
        ...
        if equippedTool and equippedTool:FindFirstChild('Ammo') then
            ...
            Library:Notify('Equip a tool to use this function. | hysteria.cc', 5)
        end
    end
end)
