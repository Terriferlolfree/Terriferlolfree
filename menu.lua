...
local function CreateTab(name)
    ...
    button.MouseButton1Click:Connect(function()
        for tabName,p in pairs(Pages) do
            p.Visible = false
            local b = Navigation:FindFirstChild(tabName)
            if b then
...
local AntiAim = CreateTab("Anti Aim")
local UISettings = CreateTab("UI Settings")

--// Combat UI
Section(Combat,"Aimbot")
Toggle(Combat,"Aimbot",false)
Toggle(Combat,"Silent Aim",false)
Toggle(Combat,"Auto Shoot",false)
Toggle(Combat,"Auto Air",false)

Section(Combat,"Target")
Button(Combat,"Target Part")
Button(Combat,"Target Method")
Toggle(Combat,"Prediction",false)

--// Visuals UI
Section(Visuals,"ESP")
Toggle(Visuals,"ESP",false)
Toggle(Visuals,"Boxes",false)
Toggle(Visuals,"Names",false)
Toggle(Visuals,"Health",false)
Toggle(Visuals,"Distance",false)

Section(Visuals,"World")
Toggle(Visuals,"Full Bright",false)
Toggle(Visuals,"No Fog",false)

--// Rage UI
Section(Rage,"Rage")
Toggle(Rage,"Fling",false)
Toggle(Rage,"Spin",false)
Toggle(Rage,"Target Strafe",false)
Button(Rage,"Target Player")
Button(Rage,"Fling Method")

--// Player UI
Section(Player,"Movement")
TextBox(Player,"WalkSpeed")
TextBox(Player,"JumpPower")
Toggle(Player,"Fly",false)
Toggle(Player,"Noclip",false)

Section(Player,"Player")
Button(Player,"Respawn")
Button(Player,"Reset Character")
Button(Player,"Spectate")

--// Anti Aim UI
Section(AntiAim,"Anti Aim")
Toggle(AntiAim,"Anti Aim",false)
Toggle(AntiAim,"Spin",false)
Toggle(AntiAim,"Jitter",false)
Button(AntiAim,"Pitch")
Button(AntiAim,"Yaw")

--// UI Settings
Section(UISettings,"Interface")
Toggle(UISettings,"Keybinds",true)
Toggle(UISettings,"Notifications",true)
Toggle(UISettings,"Watermark",true)
Button(UISettings,"Reset UI")
Button(UISettings,"Unload UI")

--// Open Combat by default
Pages.Combat.Visible = true
local combatButton = Navigation:FindFirstChild("Combat")
if combatButton then
    combatButton.BackgroundColor3 = Color3.fromRGB(32,32,38)
    combatButton.TextColor3 = Color3.fromRGB(235,235,240)
end
